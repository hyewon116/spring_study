...
<body>
	<!-- 카카오 로그인 -->
	<a class="p-2" href="https://kauth.kakao.com/oauth/authorize?client_id=33a3be212e0c64763c509546db0677b4&redirect_uri=http://localhost:8080/ictedu/kakaoLogin&response_type=code">
